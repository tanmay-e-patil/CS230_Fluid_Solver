	...
	*/
	...
	for (int i = 0; i < xDim; ++i) {
		for (int j = 0; j < yDim; ++j) {
			...
			vector<int> xCellsLeftAndRight = cellLeftOrRight(alpha, cell_x_prev, x_prev, xDim-1);
			vector<int> yCellsTopAndBottom = cellLeftOrRight(alpha, cell_y_prev, y_prev, yDim-1);
